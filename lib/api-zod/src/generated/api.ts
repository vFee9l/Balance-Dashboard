...
export const GetGrafanaBalancesResponseItem = zod.object({
  ...
  recentDailyConsumption: zod
    .number()
    .describe("Average daily consumption over the last 7 days"),
  daysRemainingRecent: zod
    .number()
    .describe(
      "Estimated days remaining based on the last 7-day consumption rate (-1 if no data)",
    ),
  yesterdayConsumption: zod
    .number()
    .describe("Actual SMS consumption yesterday"),
  dailyChangePercent: zod
    .number()
    .nullish()
    .describe(
...
export const GetGrafanaBalancesResponse = zod.array(
  GetGrafanaBalancesResponseItem,
);
