...
export const getGetTotpSetupQueryKey = () => {
  return [`/api/settings/totp-setup`] as const;
};

export const getGetTotpSetupQueryOptions = <
  TData = Awaited<ReturnType<typeof getTotpSetup>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof getTotpSetup>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getTotpSetup>>> = ({
    signal,
  }) => getTotpSetup({ signal, ...requestOptions });
...
export type GetTotpSetupQueryResult = NonNullable<
  Awaited<ReturnType<typeof getTotpSetup>>
>;
...
export function useGetTotpSetup<
  TData = Awaited<ReturnType<typeof getTotpSetup>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
 ...
 */
export const getGetConsumptionHistoryUrl = (
  params: GetConsumptionHistoryParams,
) => {
  ...
  return stringifiedParams.length > 0
    ? `/api/grafana/consumption-history?${stringifiedParams}`
    : `/api/grafana/consumption-history`;
};
...
export const getGetConsumptionHistoryQueryKey = (
  params?: GetConsumptionHistoryParams,
) => {
  return [
    `/api/grafana/consumption-history`,
...
export const getGetConsumptionHistoryQueryOptions = <
  TData = Awaited<ReturnType<typeof getConsumptionHistory>>,
  TError = ErrorType<ErrorResponse>,
>(
  params: GetConsumptionHistoryParams,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof getConsumptionHistory>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetConsumptionHistoryQueryKey(params);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getConsumptionHistory>>
  > = ({ signal }) =>
    getConsumptionHistory(params, { signal, ...requestOptions });
...
export type GetConsumptionHistoryQueryResult = NonNullable<
  Awaited<ReturnType<typeof getConsumptionHistory>>
>;
...
export function useGetConsumptionHistory<
  TData = Awaited<ReturnType<typeof getConsumptionHistory>>,
  TError = ErrorType<ErrorResponse>,
>(
  params: GetConsumptionHistoryParams,
...
export const getGrafanaBalances = async (
  options?: RequestInit,
...
export const getGetGrafanaBalancesQueryKey = () => {
  return [`/api/grafana/balances`] as const;
};

export const getGetGrafanaBalancesQueryOptions = <
  TData = Awaited<ReturnType<typeof getGrafanaBalances>>,
  TError = ErrorType<ErrorResponse>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof getGrafanaBalances>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getGrafanaBalances>>
  > = ({ signal }) => getGrafanaBalances({ signal, ...requestOptions });
...
export type GetGrafanaBalancesQueryResult = NonNullable<
  Awaited<ReturnType<typeof getGrafanaBalances>>
>;
...
export function useGetGrafanaBalances<
  TData = Awaited<ReturnType<typeof getGrafanaBalances>>,
  TError = ErrorType<ErrorResponse>,
>(options?: {
  query?: UseQueryOptions<
...
export const getTriggerAlertsMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type TriggerAlertsMutationResult = NonNullable<
  Awaited<ReturnType<typeof triggerAlerts>>
>;
...
>(options?: {
  ...
  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof listAlertHistory>>
  > = ({ signal }) => listAlertHistory({ signal, ...requestOptions });
